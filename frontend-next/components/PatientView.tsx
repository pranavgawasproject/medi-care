...
export function PatientView({
  ...
  onBook: (appt: Omit<Appointment, 'id'>) => void
  ...
  const selectedDoctor = useMemo<Doctor>(
    () =>
    ...
    <div className="space-y-6">
        ...
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-wider text-muted-foreground">
              <span className="h-1.5 w-1.5 rounded-full bg-primary" /> Patient
              Chart
            </div>
            <h2
          ...
          <div className="grid grid-cols-3 gap-3 lg:gap-4">
            ...
            />
            <HeroStat icon={TrendingUp} label="HealthScore" value="92" />
          </div>
        </div>
      </motion.div>
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-muted/30">
          ...
          <CardDescription>
            Choose a practitioner, date, and time slot
          </CardDescription>
        </CardHeader>
            ...
            <div className="rounded-md border border-border bg-card p-4">
              ...
              <div className="rounded-md bg-muted/40 p-3 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  {bookingDate
                    ? format(parseISO(bookingDate), 'MMM d, yyyy')
                    : 'Pick a date'}
                </p>
              </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-md border border-dashed border-border bg-muted/20 p-3 text-xs text-muted-foreground">
              <p className="flex items-center gap-1.5 font-medium text-foreground">
                ...
                {bookingDate
                  ? format(parseISO(bookingDate), 'EEEE, MMM d')
                  : 'Select a date'}
                {selectedSlot && (
            ...
            <Button onClick={handleRequest} className="h-10 w-full">
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-muted/30">
          <CardTitle>
            <Activity className="h-4 w-4 text-primary" /> My Consultations
            History
          </CardTitle>
...
function HeroStat({
  ...
  return (
    <div className="rounded-md border border-border bg-muted/30 p-3">
      ...
      <p className="mt-1.5 font-mono text-2xl font-semibold leading-none">
        {value}
      </p>
